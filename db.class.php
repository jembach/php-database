...
class db
{
    ...
    public $lastErrno; // Holds the last error code number
...
{
    public $start; //the start point;
    //when $limit not set this var is used to count how much rowse should returned
    public $limit; //count of rows which should be returned
...
{
    public $source; //source table                       - format: tablename.column
    public $destination; //table on which should be joined - format: tablename.column
...
{
    public $column; //column where data should be in
    public $list; //list of data
    public $crypted_column; //a list of crypted columns used in a query
    public $key; //the key for the cryption
...
{
    public $column; //the column on which the condition should be run on
    public $cond; //the statement which should be fulfill
    public $operator; //the operator which should be used to connect column and operator
    public $connect; //the connector to connect multiple dbCond
    public $crypted_column; //a list of crypted columns used in a query
    public $key; //the key for the cryption
...
{
    public $cond = array(); //a list of dbCond-objects which should be connected
    public $key; //the key for the cryption
...
class dbInc
{
    public $num; //the number how much should be increased
...
class dbFunc
{
    public $func; //SQL method
    public $params; //parameters for SQL method
...
{
    public $column; //the column where should be ordered on
    public $direction; //the order algorithm
...
{
    public $columns; //the column where should be grouped on
...
{
    public $column; //a list of column which should be selected
...
class dbCrypt
{
    public $columns; //a list of column which are crypted
...
>>>>>>> e754ac99a5feb1b557f20b72ed2cd5697d55a5bf
 */
class dbOnDuplicateKeyUpdate
{
    public $actions;
